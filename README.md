...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/raspy-dawn-4267
```

A live public deployment of this template is available at [https://raspy-dawn-4267.templates.workers.dev](https://raspy-dawn-4267.templates.workers.dev)
